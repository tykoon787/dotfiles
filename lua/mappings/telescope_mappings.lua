...
key_map("n", "<leader>st", ":lua require'_telescope'.search_todos()<CR>", { noremap = true, silent = true })
...
-- telescope-repo
key_map("n", "<leader>rl", [[<Cmd>lua require'_telescope'.repo_list()<CR>]], { noremap = true, silent = true })
...
key_map("n", ",<space>", [[<Cmd>lua require'_telescope'.project_files()<CR>]], { noremap = true, silent = true })
-- browse, explore and create notes
key_map("n", ",n", [[<Cmd>lua require'_telescope'.browse_notes()<CR>]], { noremap = true, silent = true })
-- Explore files starting at $HOME
key_map("n", ",e", [[<Cmd>lua require'_telescope'.file_explorer()<CR>]], { noremap = true, silent = true })
...
-- find notes
key_map("n", "<leader>n", [[<Cmd>lua require'_telescope'.find_notes()<CR>]], { noremap = true, silent = true })
-- search notes
key_map("n", "<space>n", [[<Cmd>lua require'_telescope'.grep_notes()<CR>]], { noremap = true, silent = true })
-- Find files in config dirs
key_map("n", "<space>e", [[<Cmd>lua require'_telescope'.find_configs()<CR>]], { noremap = true, silent = true })
-- greg for a string
key_map("n", "<space>g", [[<Cmd>lua require'_telescope'.grep_prompt()<CR>]], { noremap = true, silent = true })
-- find or create neovim configs
key_map("n", "<leader>nc", [[<Cmd>lua require'_telescope'.nvim_config()<CR>]], { noremap = true, silent = true })

-- Github issues
key_map("n", "<leader>is", [[<Cmd>lua require'_telescope'.gh_issues()<CR>]], { noremap = true, silent = true })
-- github Pull Requests - PRs
key_map("n", "<leader>pr", [[<Cmd>lua require'_telescope'.gh_prs()<CR>]], { noremap = true, silent = true })
...
key_map("n", "<leader>ns", [[<Cmd>lua require'_telescope'.grep_nvim_src()<CR>]], { noremap = true, silent = true })
-- End Telescope maps
